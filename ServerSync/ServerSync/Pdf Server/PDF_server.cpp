...
{
   int check;
   string access_token = "PDF$";  // This is access token of file server
...
////////////////////////////////////////////////////////////////////////
   ...
   cout<<": : : : : : : : : : _PDF_ SERVER READY FOR CLIENT : : : : : : : :\n\n";
   cout<<": : : : : : : : : : : : : : : : : : : : : : : :  : : : : : : : :\n\n";
...
//------------------- Sending the file to server  ----------------------
    ...
    cout<<"Sending  PDF to client \n"; 
    ifstream my_file;
    my_file.open("pdf.pdf",std::ios::binary);  
    ...
    my_file.close();
    cout<<"PDF sending completed successfully. . .  \n";
  }
